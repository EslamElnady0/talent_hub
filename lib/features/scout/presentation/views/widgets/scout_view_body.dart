...
class ScoutViewBody extends StatelessWidget {
  const ScoutViewBody({super.key, required this.posts, required this.userModel,});
  ...
  Widget build(BuildContext context) {
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        return CustomPlayerPost(postModel: posts[index],index: index, userModel: userModel);
      },
